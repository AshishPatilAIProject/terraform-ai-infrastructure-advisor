...
import os
SECURITY_CHECK_PROMPT_PATH = os.path.normpath(
    os.path.join(os.path.dirname(__file__), "..", "..", "prompts", "security_check_ai_prompt.md")
)
...
def run_security_agent(terraform_code: str) -> List[Finding]:
